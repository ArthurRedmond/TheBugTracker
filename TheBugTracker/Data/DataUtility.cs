            ...
            try
            {
                IList<Project> projects = new List<Project>() {
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2022,5,01),
                         EndDate = new DateTime(2022,5,01).AddMonths(1),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2022,5,01),
                         EndDate = new DateTime(2022,5,01).AddMonths(4),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2022,5,01),
                         EndDate = new DateTime(2022,5,01).AddMonths(6),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2022,5,01),
                         EndDate = new DateTime(2022,5,01).AddMonths(2),
                         ProjectPriorityId = priorityLow
                     },
                    new Project()
                     {
                         ...
                         StartDate = new DateTime(2022,5,01),
                         EndDate = new DateTime(2022,5,01).AddMonths(3),
                         ProjectPriorityId = priorityHigh
                     }
                };
